...
CREATE TABLE "Dreccion" (
    ...
    CONSTRAINT "Dreccion_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "UsuarioDireccion" ADD CONSTRAINT "UsuarioDireccion_direccion_id_fkey" FOREIGN KEY ("direccion_id") REFERENCES "Dreccion"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Detalle" ADD CONSTRAINT "Detalle_decuento_id_fkey" FOREIGN KEY ("decuento_id") REFERENCES "Descuento"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
